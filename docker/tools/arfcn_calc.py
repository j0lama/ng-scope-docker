    ...
    for band in lte_bands:
        if 18000 <= dl_earfcn < 36000:
            if band['NUL_Min'] <= dl_earfcn <= band['NUL_Max']:
                return band['FUL_Low'] + 0.1 * (dl_earfcn - band['NUL_Min'])
        elif dl_earfcn < 36000 or 65535 < dl_earfcn <= 98303:
            if band['NDL_Min'] <= dl_earfcn <= band['NDL_Max']:
                return band['FDL_Low'] + 0.1 * (dl_earfcn - band['NDL_Min'])
    return None